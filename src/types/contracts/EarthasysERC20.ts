...
export interface EarthasysERC20Interface extends utils.Interface {
  functions: {
...
export interface EarthasysERC20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EarthasysERC20Interface;
  ...
  functions: {
    ...
    getERC20Metadata(overrides?: CallOverrides): Promise<[string, string, string, string, string]>;
